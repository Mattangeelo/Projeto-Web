    ...
    <div class="product-content product-wrap clearfix product-deatil">
        <div class="row">
            ...
            <div class="col-md-7 col-md-offset-1 col-sm-12 col-xs-12">
                ...
                <p class="small">Escolha um Tamanho</p>
                ...
                <div class="row" style="margin-top: 4rem">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" name="produto[quantidade]" placeholder="Quantidade" value="1" min="1" max="10" ste="1" required="">
                    </div>
                </div>
                <hr />
                ...
                <div class="row">
                    ...
                    <?php endforeach; ?>
                    <div class="col-sm-4">
                                <a href="<?php echo site_url("/"); ?>" class="btn btn-info btn-block">Voltar</a>
                            </div>  
                </div>
